 ...
 */
package com.cooptest.view.home;
...
public class Home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Usuário logado: José Augusto Braz | Unidade de Campo Mourão - PR");
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        CooperatedDao cooperatedDao = new CooperatedDao();
        ProductDao productDao = new ProductDao();
        ProductGroupDao productGroupDao = new ProductGroupDao();
        TributeDao tributeDao = new TributeDao();
        
        if (Frames.sale == null)
            Frames.sale = new Sale(cooperatedDao, productDao, productGroupDao, tributeDao);
        
        Frames.sale.setVisible(true);
